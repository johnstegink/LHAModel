...
$VENVDIR/python createrelationsfrom2.py -c1 $COPRUSDIR/simple -c2 $COPRUSDIR/en -i1 $OUTDIR/simple/documentvectors.xml -i2 $OUTDIR/en/documentvectors.xml -o $OUTDIR/relations.xml -d 70 -r $OUTDIR/relations.html
